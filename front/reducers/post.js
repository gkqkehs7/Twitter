...
export const LOAD_HASHTAG_POSTS_FAILURE = 'LOAD_HASGTAG_POSTS_FAILURE';
...
const reducer = (state = initialState, action) => produce(state, (draft) => {
  switch (action.type) {
    ...
    case RETWEET_FAILURE:
      ...
      break;
    case REMOVE_IMAGE: //서버쪽에서 안지워도 되니까 이렇게만 쓰면 ok 이미지는 서버에서 잘 안지움
    ...
    case UPLOAD_IMAGES_SUCCESS: {
      draft.imagePaths = action.data; //이미지 path저장
